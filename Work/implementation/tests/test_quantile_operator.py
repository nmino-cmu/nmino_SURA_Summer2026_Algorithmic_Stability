from operators.quantile.math import EVALUATION_METHOD, OPERATOR, SHARPNESS_STATEMENT, THEOREM_ID, THEOREM_STATEMENT, invariance_holds, is_strict_kth
from operators.quantile.verify import verify_quantile_margin
