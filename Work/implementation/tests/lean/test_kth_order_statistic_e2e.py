...
import pytest
from operators.kth_order_statistic.workflow import run_kth_order_statistic_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle

@pytest.mark.lean
def test_kth_order_statistic_e2e_full():
    r = run_kth_order_statistic_margin_workflow(export_lean_bundle=True)
