...
import pytest
from operators.bucket_assignment.workflow import run_bucket_assignment_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_bucket_assignment_e2e_full():
    r=run_bucket_assignment_margin_workflow(export_lean_bundle=True)
