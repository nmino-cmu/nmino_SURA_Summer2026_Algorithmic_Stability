...
import pytest
from operators.partial_sorting.workflow import run_partial_sorting_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_partial_sorting_e2e_full():
    r=run_partial_sorting_margin_workflow(export_lean_bundle=True)
