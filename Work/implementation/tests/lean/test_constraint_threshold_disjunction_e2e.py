...
import pytest
from operators.constraint_threshold_disjunction.workflow import run_constraint_threshold_disjunction_preservation_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_constraint_threshold_disjunction_e2e_full():
    r = run_constraint_threshold_disjunction_preservation_workflow(export_lean_bundle=True)
