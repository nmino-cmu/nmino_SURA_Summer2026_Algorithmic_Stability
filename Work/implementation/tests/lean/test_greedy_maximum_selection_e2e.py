...
import pytest
from operators.greedy_maximum_selection.workflow import run_greedy_maximum_selection_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_greedy_maximum_selection_e2e_full():
    r = run_greedy_maximum_selection_margin_workflow(export_lean_bundle=True)
