...
import pytest
from operators.priority_queue_maximum.workflow import run_priority_queue_maximum_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_priority_queue_maximum_e2e_full():
    r = run_priority_queue_maximum_margin_workflow(export_lean_bundle=True)
