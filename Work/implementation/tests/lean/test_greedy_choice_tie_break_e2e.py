...
import pytest
from operators.greedy_choice_tie_break.workflow import run_greedy_choice_tie_break_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_greedy_choice_tie_break_e2e_full():
    r = run_greedy_choice_tie_break_margin_workflow(export_lean_bundle=True)
