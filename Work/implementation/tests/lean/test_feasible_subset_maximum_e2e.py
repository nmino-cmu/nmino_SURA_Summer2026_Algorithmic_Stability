...
import pytest
from operators.feasible_subset_maximum.workflow import run_feasible_subset_maximum_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_feasible_subset_maximum_e2e_full():
    r = run_feasible_subset_maximum_margin_workflow(export_lean_bundle=True)
