...
import pytest
from operators.masked_top_k.workflow import run_masked_top_k_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_masked_top_k_e2e_full():
    r=run_masked_top_k_margin_workflow(export_lean_bundle=True)
