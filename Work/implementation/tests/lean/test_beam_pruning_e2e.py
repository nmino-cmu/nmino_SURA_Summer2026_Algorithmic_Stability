...
import pytest
from operators.beam_pruning.workflow import run_beam_pruning_margin_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle
@pytest.mark.lean
def test_beam_pruning_e2e_full():
    r=run_beam_pruning_margin_workflow(export_lean_bundle=True)
