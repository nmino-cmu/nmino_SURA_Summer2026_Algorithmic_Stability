"""E2E bundle → LEAN_FULL for threshold preservation (requires lake)."""

from pathlib import Path

import pytest

from operators.thresholding.workflow import run_threshold_preservation_workflow
from system_b.lean.manifest import DerivedLeanStatus
from system_b.lean.workflow import run_lean_from_bundle


@pytest.mark.lean
def test_threshold_e2e_full():
    r = run_threshold_preservation_workflow(export_lean_bundle=True)
