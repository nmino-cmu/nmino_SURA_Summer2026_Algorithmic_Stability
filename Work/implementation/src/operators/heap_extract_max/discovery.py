...
from operators.heap_extract_max.math import (
...
def discover_heap_extract_max(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Heap extract-max via Argmax margin", "reduction": "argmax_margin"},
    )
