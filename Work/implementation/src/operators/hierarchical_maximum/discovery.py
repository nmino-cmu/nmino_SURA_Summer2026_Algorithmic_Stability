...
from operators.hierarchical_maximum.math import (
...
def discover_hierarchical_maximum(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Hierarchical maximum via Argmax margin", "reduction": "argmax_margin"},
    )
