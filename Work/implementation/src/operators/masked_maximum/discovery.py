...
from operators.masked_maximum.math import (
...
def discover_masked_maximum(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Masked maximum via Argmax margin", "reduction": "argmax_margin"},
    )
