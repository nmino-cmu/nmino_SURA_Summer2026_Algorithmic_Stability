...
def claim_is_projection_l2_ball_preservation(claim):
    return (
...
def verify_projection_l2_ball_preservation(claim):
    if not claim_is_projection_l2_ball_preservation(claim):
