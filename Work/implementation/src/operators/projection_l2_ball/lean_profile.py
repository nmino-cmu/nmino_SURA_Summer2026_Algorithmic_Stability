...
from operators.projection_l2_ball.math import EVALUATION_METHOD, OPERATOR, THEOREM_ID, THEOREM_STATEMENT as _TS
CONCL_SCHEMA = "ARTLEAN.CONCL.projection_l2_ball.v1"
...
TARGETS = [{'target_id': 'preservation', 'prop_fully_qualified': 'Research.Operators.ProjectionL2Ball.Preservation.ProjectionL2BallIdentityProp', 'theorem_name': 'projection_l2_ball_feasible_ball_identity', 'lemma_deps': []}, {'target_id': 'sharpness', 'prop_fully_qualified': 'Research.Operators.ProjectionL2Ball.Preservation.ProjectionL2BallSharpnessProp', 'theorem_name': 'projection_l2_ball_feasible_ball_sharpness', 'lemma_deps': []}]
KNOWN_GAPS = ["DEFINITION_PINS_SURROGATE"]
LEAN_NAMESPACE = "Research.Operators.ProjectionL2Ball.Preservation"
PROP_RELATIVE = Path("Research/Operators/ProjectionL2Ball/Preservation.lean")
MATH_PY_RELATIVE = Path("implementation/src/operators/projection_l2_ball/math.py")
