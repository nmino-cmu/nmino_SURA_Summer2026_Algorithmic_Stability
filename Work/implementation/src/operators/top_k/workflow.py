...
from operators.top_k.discovery import discover_top_k
...
def run_top_k_margin_workflow(*, export_lean_bundle: bool = False) -> ResearchResult:
    ...
    vid = orch.compile_portfolio_member("top_k", "PHASE_A_CHARACTERIZATION", "top_k-margin")
