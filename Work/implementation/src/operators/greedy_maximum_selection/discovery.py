...
def discover_greedy_maximum_selection(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Greedy maximum selection via Argmax margin", "reduction": "argmax_margin"},
    )
