...
from operators.greedy_maximum_selection.math import (
...
def claim_is_greedy_maximum_selection_margin(claim):
    return (
...
def verify_greedy_maximum_selection_margin(claim):
    if not claim_is_greedy_maximum_selection_margin(claim):
