...
from operators.penalized_score_selection.math import (
...
def claim_is_penalized_score_selection_margin(claim):
    return (
...
def verify_penalized_score_selection_margin(claim):
    if not claim_is_penalized_score_selection_margin(claim):
