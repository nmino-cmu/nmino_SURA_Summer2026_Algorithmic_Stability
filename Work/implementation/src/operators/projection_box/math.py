"""Projection onto box constraints - interval clamp nonexpansiveness (Real)."""
from __future__ import annotations
import random

OPERATOR = "projection-box"
THEOREM_ID = "projection-box-clamp-stability"
EVALUATION_METHOD = "PROJECTION_BOX_COMPUTATIONAL_V1"
THEOREM_STATEMENT = ("Let lo<=hi and |x'-x|<=epsilon. Then |clamp(x';lo,hi)-clamp(x;lo,hi)|<=epsilon (Projection onto box constraints is 1-Lipschitz / nonexpansive on Int).")
