...
def discover_projection_box(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir, {"name": OPERATOR, "form": "Projection onto box constraints", "kind": "clamp"}
    )
    ...
    claim = {
        ...
        "formal": {'operator_kind': 'clamp_projection', 'perturbation': 'abs_ball', 'property': '1_lipschitz_nonexpansive'},
    }
    tip = ir.mint(
