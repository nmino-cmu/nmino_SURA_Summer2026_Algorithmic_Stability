...
def discover_constraint_threshold_conjunction(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir, {"name": OPERATOR, "form": "Constraint-threshold conjunction", "kind": "conjunction"}
    )
    ...
    claim = {
        ...
        "formal": {'operator_kind': 'threshold_conjunction', 'reduction': 'multi_threshold_pass_count', 'perturbation': 'abs_ball'},
    }
    tip = ir.mint(
