...
def claim_is_constraint_threshold_conjunction_preservation(claim):
    return (
...
def verify_constraint_threshold_conjunction_preservation(claim):
    if not claim_is_constraint_threshold_conjunction_preservation(claim):
