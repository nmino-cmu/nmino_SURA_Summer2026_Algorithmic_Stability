...
from operators.heap_top.math import EVALUATION_METHOD, OPERATOR, THEOREM_ID, THEOREM_STATEMENT as _TS
CONCL_SCHEMA = "ARTLEAN.CONCL.heap_top_margin.v1"
...
TARGETS = [
  {
    ...
    "prop_fully_qualified": "Research.Operators.HeapTop.Margin.HeapTopMarginInvarianceProp",
    "theorem_name": "heap_top_margin_invariance",
    "lemma_deps": [],
  },
  {
    "target_id": "sharpness",
    "prop_fully_qualified": "Research.Operators.HeapTop.Margin.HeapTopMarginSharpnessProp",
    "theorem_name": "heap_top_margin_sharpness",
    "lemma_deps": [],
  }]
KNOWN_GAPS = ["DEFINITION_PINS_SURROGATE"]
LEAN_NAMESPACE = "Research.Operators.HeapTop.Margin"
PROP_RELATIVE = Path("Research/Operators/HeapTop/Margin.lean")
MATH_PY_RELATIVE = Path("implementation/src/operators/heap_top/math.py")
...
PROP_DEPS = (
    Path("Research/Operators/HeapTop/Margin.lean"),
