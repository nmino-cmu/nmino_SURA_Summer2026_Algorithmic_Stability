...
def discover_weighted_tournament_winner(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Weighted tournament winner via Argmax margin", "reduction": "argmax_margin"},
    )
