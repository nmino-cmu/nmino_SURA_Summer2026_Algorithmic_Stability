...
def claim_is_weighted_tournament_winner_margin(claim):
    return (
...
def verify_weighted_tournament_winner_margin(claim):
    if not claim_is_weighted_tournament_winner_margin(claim):
