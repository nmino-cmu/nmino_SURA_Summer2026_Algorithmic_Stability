...
def claim_is_groupwise_then_global_maximum_margin(claim):
    return (
...
def verify_groupwise_then_global_maximum_margin(claim):
    if not claim_is_groupwise_then_global_maximum_margin(claim):
