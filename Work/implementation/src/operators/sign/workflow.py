...
from operators.sign.discovery import discover_sign
...
def run_sign_preservation_workflow(*, export_lean_bundle: bool = False) -> SignResearchResult:
    ...
    vid = orch.compile_portfolio_member("sign", "PHASE_A_CHARACTERIZATION", "sign-preservation")
