...
from operators.greedy_choice_tie_break.math import (
...
def discover_greedy_choice_tie_break(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Greedy choice with deterministic tie-breaking via Argmax margin", "reduction": "argmax_margin"},
    )
