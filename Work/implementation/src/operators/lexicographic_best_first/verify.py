...
def claim_is_lexicographic_best_first_margin(claim):
    return (
...
def verify_lexicographic_best_first_margin(claim):
    if not claim_is_lexicographic_best_first_margin(claim):
