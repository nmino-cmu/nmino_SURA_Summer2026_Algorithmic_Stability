...
def discover_lexicographic_best_first(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Lexicographic best-first via Argmax margin", "reduction": "argmax_margin"},
    )
