...
from operators.best_first_node_selection.math import (
...
def claim_is_best_first_node_selection_margin(claim):
    return (
...
def verify_best_first_node_selection_margin(claim):
    if not claim_is_best_first_node_selection_margin(claim):
