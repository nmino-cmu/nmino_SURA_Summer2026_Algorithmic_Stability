...
def discover_best_first_node_selection(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Best-first node selection via Argmax margin", "reduction": "argmax_margin"},
    )
