...
from operators.median.discovery import discover_median
...
def run_median_margin_workflow(*, export_lean_bundle: bool = False) -> ResearchResult:
    ...
    vid = orch.compile_portfolio_member("median", "PHASE_A_CHARACTERIZATION", "median-margin")
