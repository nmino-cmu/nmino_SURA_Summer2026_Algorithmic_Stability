...
from operators.median.math import EVALUATION_METHOD, OPERATOR, THEOREM_ID, THEOREM_STATEMENT as _TS

CONCL_SCHEMA = "ARTLEAN.CONCL.median_margin.v1"
...
TARGETS = [
    {
        ...
        "prop_fully_qualified": "Research.Operators.Median.Preservation.MedianMarginInvarianceProp",
        "theorem_name": "median_margin_invariance",
        "lemma_deps": [],
    },
    {
        "target_id": "sharpness",
        "prop_fully_qualified": "Research.Operators.Median.Preservation.MedianMarginSharpnessProp",
        "theorem_name": "median_margin_sharpness",
        "lemma_deps": [],
    }]
KNOWN_GAPS = ["DEFINITION_PINS_SURROGATE"]
LEAN_NAMESPACE = "Research.Operators.Median.Preservation"
PROP_RELATIVE = Path("Research/Operators/Median/Preservation.lean")
MATH_PY_RELATIVE = Path("implementation/src/operators/median/math.py")
...
PROP_DEPS = (
    Path("Research/Operators/Median/Preservation.lean"),
