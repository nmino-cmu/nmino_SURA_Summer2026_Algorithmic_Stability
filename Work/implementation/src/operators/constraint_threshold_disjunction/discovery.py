...
def discover_constraint_threshold_disjunction(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir, {"name": OPERATOR, "form": "Constraint-threshold disjunction", "kind": "disjunction"}
    )
    ...
    claim = {
        ...
        "formal": {'operator_kind': 'threshold_disjunction', 'reduction': 'multi_threshold_pass_count', 'perturbation': 'abs_ball'},
    }
    tip = ir.mint(
