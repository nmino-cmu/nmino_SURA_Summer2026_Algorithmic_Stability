...
def claim_is_coordinate_clipping_preservation(claim):
    return (
...
def verify_coordinate_clipping_preservation(claim):
    if not claim_is_coordinate_clipping_preservation(claim):
