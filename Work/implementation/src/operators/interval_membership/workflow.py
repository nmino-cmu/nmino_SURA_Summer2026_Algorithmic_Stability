...
from operators.interval_membership.discovery import discover_interval_membership
...
@dataclass
class IntervalMembershipResearchResult:
    session_id: str
...
def run_interval_membership_preservation_workflow(
    *, export_lean_bundle: bool = False
    ...
    vid = orch.compile_portfolio_member(
        "interval-membership", "PHASE_A_CHARACTERIZATION", "interval-membership-preservation"
    )
    ...
    return IntervalMembershipResearchResult(
