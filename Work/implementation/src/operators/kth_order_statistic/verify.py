...
from operators.kth_order_statistic.math import (
...
def claim_is_kth_order_statistic_margin(claim: dict[str, Any]) -> bool:
    return (
...
def verify_kth_order_statistic_margin(claim: dict[str, Any]) -> VerifyResult:
    if not claim_is_kth_order_statistic_margin(claim):
