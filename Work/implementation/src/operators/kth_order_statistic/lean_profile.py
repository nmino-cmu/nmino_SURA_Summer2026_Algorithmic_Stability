...
from operators.kth_order_statistic.math import EVALUATION_METHOD, OPERATOR, THEOREM_ID, THEOREM_STATEMENT as _TS

CONCL_SCHEMA = "ARTLEAN.CONCL.kth_order_statistic_margin.v1"
...
TARGETS = [
    {
        ...
        "prop_fully_qualified": "Research.Operators.KthOrderStatistic.Preservation.KthOrderStatisticMarginInvarianceProp",
        "theorem_name": "kth_order_statistic_margin_invariance",
        "lemma_deps": [],
    },
    {
        "target_id": "sharpness",
        "prop_fully_qualified": "Research.Operators.KthOrderStatistic.Preservation.KthOrderStatisticMarginSharpnessProp",
        "theorem_name": "kth_order_statistic_margin_sharpness",
        "lemma_deps": [],
    }]
KNOWN_GAPS = ["DEFINITION_PINS_SURROGATE"]
LEAN_NAMESPACE = "Research.Operators.KthOrderStatistic.Preservation"
PROP_RELATIVE = Path("Research/Operators/KthOrderStatistic/Preservation.lean")
MATH_PY_RELATIVE = Path("implementation/src/operators/kth_order_statistic/math.py")
...
PROP_DEPS = (
    Path("Research/Operators/KthOrderStatistic/Preservation.lean"),
