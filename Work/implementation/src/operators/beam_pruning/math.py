"""Beam pruning — ranking-margin core (Real)."""
...
EVALUATION_METHOD = "BEAM_PRUNING_MARGIN_COMPUTATIONAL_V1"
THEOREM_STATEMENT = ('Let n≥2, s∈ℤ^n, ε≥0. If every pairwise gap exceeds 2ε and ‖δ‖_∞≤ε, then for all indices i,j: s_i < s_j iff (s+δ)_i < (s+δ)_j. (Beam pruning uses this ranking core.)')
