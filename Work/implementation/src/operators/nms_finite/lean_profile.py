...
from operators.nms_finite.math import EVALUATION_METHOD, OPERATOR, THEOREM_ID, THEOREM_STATEMENT as _TS
CONCL_SCHEMA = "ARTLEAN.CONCL.nms_finite_margin.v1"
...
TARGETS = [
  {
    ...
    "prop_fully_qualified": "Research.Operators.NmsFinite.Margin.NmsFiniteMarginInvarianceProp",
    "theorem_name": "nms_finite_margin_invariance",
    "lemma_deps": [],
  },
  {
    "target_id": "sharpness",
    "prop_fully_qualified": "Research.Operators.NmsFinite.Margin.NmsFiniteMarginSharpnessProp",
    "theorem_name": "nms_finite_margin_sharpness",
    "lemma_deps": [],
  }]
KNOWN_GAPS = ["DEFINITION_PINS_SURROGATE"]
LEAN_NAMESPACE = "Research.Operators.NmsFinite.Margin"
PROP_RELATIVE = Path("Research/Operators/NmsFinite/Margin.lean")
MATH_PY_RELATIVE = Path("implementation/src/operators/nms_finite/math.py")
...
PROP_DEPS = (
    Path("Research/Operators/NmsFinite/Margin.lean"),
