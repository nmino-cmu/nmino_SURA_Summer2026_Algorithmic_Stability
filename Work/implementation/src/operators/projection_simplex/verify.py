...
def claim_is_projection_simplex_preservation(claim):
    return (
...
def verify_projection_simplex_preservation(claim):
    if not claim_is_projection_simplex_preservation(claim):
