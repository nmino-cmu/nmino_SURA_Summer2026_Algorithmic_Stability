...
from operators.priority_queue_maximum.math import (
...
def discover_priority_queue_maximum(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Priority queue maximum via Argmax margin", "reduction": "argmax_margin"},
    )
