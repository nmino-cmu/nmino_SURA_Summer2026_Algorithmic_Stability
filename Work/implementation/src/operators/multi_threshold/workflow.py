"""End-to-end Discovery → Verification for multi-threshold."""
...
from operators.multi_threshold.discovery import discover_multi_threshold
...
@dataclass
class MultiThresholdResearchResult:
    session_id: str
...
def run_multi_threshold_preservation_workflow(
    *, export_lean_bundle: bool = False
    ...
    vid = orch.compile_portfolio_member(
        "multi-threshold", "PHASE_A_CHARACTERIZATION", "multi-threshold-preservation"
    )
    ...
    return MultiThresholdResearchResult(
