...
from operators.tournament_winner.math import (
...
def discover_tournament_winner(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Tournament winner via Argmax margin", "reduction": "argmax_margin"},
    )
