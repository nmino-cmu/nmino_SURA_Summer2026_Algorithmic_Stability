...
def discover_weighted_score_selection(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Weighted score selection via Argmax margin", "reduction": "argmax_margin"},
    )
