...
from operators.quantile.discovery import discover_quantile
...
def run_quantile_margin_workflow(*, export_lean_bundle: bool = False) -> ResearchResult:
    ...
    vid = orch.compile_portfolio_member("quantile", "PHASE_A_CHARACTERIZATION", "quantile-margin")
