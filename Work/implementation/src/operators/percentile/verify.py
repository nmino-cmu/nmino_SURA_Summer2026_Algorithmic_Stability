...
from operators.percentile.math import (
...
def claim_is_percentile_margin(claim: dict[str, Any]) -> bool:
    return (
...
def verify_percentile_margin(claim: dict[str, Any]) -> VerifyResult:
    if not claim_is_percentile_margin(claim):
