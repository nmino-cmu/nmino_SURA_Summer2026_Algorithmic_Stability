...
def claim_is_feasibility_indicator_preservation(claim):
    return (
...
def verify_feasibility_indicator_preservation(claim):
    if not claim_is_feasibility_indicator_preservation(claim):
