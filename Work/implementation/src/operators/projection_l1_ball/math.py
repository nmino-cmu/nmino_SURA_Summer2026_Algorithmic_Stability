"""Projection onto the l1 ball - feasible-ball identity (Real, limited)."""
from __future__ import annotations

OPERATOR = "projection-l1-ball"
THEOREM_ID = "projection-l1-ball-feasible-ball-identity"
EVALUATION_METHOD = "PROJECTION_L1_BALL_COMPUTATIONAL_V1"
THEOREM_STATEMENT = ("If proj fixes InSet pointwise and the closed epsilon-ball about x lies in InSet, then for all |x'-x|<=epsilon one has proj(x')=x' and proj(x)=x (Projection onto the l1 ball: feasible-ball identity, Mathlib Real).")
