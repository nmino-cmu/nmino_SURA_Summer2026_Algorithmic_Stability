...
from operators.feasible_subset_maximum.math import (
...
def discover_feasible_subset_maximum(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Feasible-subset maximum via Argmax margin", "reduction": "argmax_margin"},
    )
