...
from operators.tie_broken_winner.math import (
...
def discover_tie_broken_winner(ir: DiscoveryIR) -> dict[str, Any]:
    op = a_engines.run_operator_analyzer(
        ir,
        {"name": OPERATOR, "form": "Tie-broken winner selection via Argmax margin", "reduction": "argmax_margin"},
    )
