...
\author{Research Architecture Runtime \\ \texttt{operator/filter-then-max}}
\date{2026-07-25}
\begin{document}
\maketitle
\begin{abstract}
Filter-then-max reduces to unique-maximizer Argmax margin stability: $\gamma>2\varepsilon$
...
\texttt{Research.Operators.FilterThenMax.Margin}.
\section{Limitations}
