...
\author{Research Architecture Runtime \\ \texttt{operator/weighted-tournament-winner}}
\date{2026-07-25}
\begin{document}
\maketitle
\begin{abstract}
Weighted tournament winner reduces to unique-maximizer Argmax margin stability: $\gamma>2\varepsilon$
...
\texttt{Research.Operators.WeightedTournamentWinner.Margin}.
\section{Limitations}
