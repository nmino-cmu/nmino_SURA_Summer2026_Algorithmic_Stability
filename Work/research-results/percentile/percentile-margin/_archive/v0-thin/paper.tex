...
\author{Research Architecture Runtime \\ \texttt{operator/percentile}}
\date{2026-07-25}
\begin{document}
\maketitle
\begin{abstract}
Percentile selection as unique strict $k$-th order statistic. Pairwise gaps $>2\varepsilon$
...
\texttt{Research.Operators.Percentile.Preservation}; \texttt{LEAN\_FULL} Mathlib $\mathbb{R}$.
\section{Limitations}
