...
{\normalsize\texttt{operator/absolute-value-threshold}}}
\date{2026-07-29}
...
\begin{abstract}
\leanpath{absolute-value-threshold} is a scalar region indicator preserved outside an $\varepsilon$-buffer under $|x'-x|\le\varepsilon$. Lean \texttt{LEAN\_FULL}.
\end{abstract}
...
\section{Problem}
{\raggedright\sloppy
The \leanpath{absolute-value-threshold} operator maps a scalar score to a discrete region label/bit.
\par}
...
\item[Lean module] \leanpath{Research.Operators.AbsThreshold.Preservation}
\item[Source file] \leanpath{lean/Research/Operators/AbsThreshold/Preservation.lean}
\item[Theorems]\leavevmode\par\vspace{0.15em}\begin{itemize}[leftmargin=1.2em]
  \item \leanpath{abs\_threshold\_preservation}
  \item \leanpath{abs\_threshold\_sharpness}
\end{itemize}
\item[Certificate] \leanpath{lean/certificates/absolute-value-threshold/abs-threshold-preservation}
...
{\raggedright\sloppy
Scalar building block; related: thresholding, sign, multi-threshold.
\par}
