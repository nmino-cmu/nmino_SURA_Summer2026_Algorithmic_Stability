...
\title{Constraint-threshold disjunction: Real Stability}
\author{Research Architecture Runtime\\[0.25em]
{\normalsize\texttt{operator/constraint-threshold-disjunction}}}
\date{2026-07-29}
...
\begin{abstract}
\leanpath{constraint-threshold-disjunction} preserves a Boolean combination of threshold constraints under buffered scalar noise. Lean \texttt{LEAN\_FULL}.
\end{abstract}
...
\item[Lean module] \leanpath{Research.Operators.ConstraintThresholdDisjunction.Preservation}
\item[Source file] \leanpath{lean/Research/Operators/ConstraintThresholdDisjunction/Preservation.lean}
\item[Theorems]\leavevmode\par\vspace{0.15em}\begin{itemize}[leftmargin=1.2em]
  \item \leanpath{constraint\_threshold\_disjunction\_disjunction\_preservation}
  \item \leanpath{constraint\_threshold\_disjunction\_disjunction\_sharpness}
\end{itemize}
\item[Certificate] \leanpath{lean/certificates/constraint-threshold-disjunction/constraint-threshold-disjunction-disjunction-preservation}
