...
Verification uses \texttt{THRESHOLD\_BOUNDED\_NOISE\_COMPUTATIONAL\_V1}.
\end{abstract}
...
computational certification only.
Limitations tagged on PASS:
\texttt{COMPUTATIONAL\_VERIFICATION\_NOT\_LEAN},
\texttt{BOUNDED\_NOISE\_NOT\_FULL\_SVT},
\texttt{LAPLACE\_CDF\_IDENTITY\_NOT\_DP\_PROOF}.
