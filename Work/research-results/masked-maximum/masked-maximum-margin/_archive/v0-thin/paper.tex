...
\author{Research Architecture Runtime \\ \texttt{operator/masked-maximum}}
\date{2026-07-25}
\begin{document}
\maketitle
\begin{abstract}
Masked maximum reduces to unique-maximizer Argmax margin stability: $\gamma>2\varepsilon$
...
\texttt{Research.Operators.MaskedMaximum.Margin}.
\section{Limitations}
