...
\author{Research Architecture Runtime \\ \texttt{operator/median}}
\date{2026-07-25}
\begin{document}
\maketitle
\begin{abstract}
Median selection as unique strict $k$-th order statistic. Pairwise gaps $>2\varepsilon$
...
\texttt{Research.Operators.Median.Preservation}; \texttt{LEAN\_FULL} Mathlib $\mathbb{R}$.
\section{Limitations}
